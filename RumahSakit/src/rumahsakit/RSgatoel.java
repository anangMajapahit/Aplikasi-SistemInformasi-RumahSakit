 ...
 * @author UmumPRT
 */
public class RSgatoel extends javax.swing.JFrame {
    ...
    private void tampilkan_data(){
        ...
        try{
            int no = 1;
            String sql = "Select * FROM rsgatoel";
            ...
            tableDataCovidRSgatoel.setModel(model);
        }catch(SQLException e){
            System.out.println("Error : "+e.getMessage());
        }
    }
    /**
     * Creates new form RSgatoel
     */
    public RSgatoel() {
        initComponents();
        kosongkan_form();
    ...
    private void initComponents() {
        ...
        tableDataCovidRSgatoel = new javax.swing.JTable();
        ...
        jLabel10.setText("RUMAH SAKIT GATOEL");
        ...
        tableDataCovidRSgatoel.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tableDataCovidRSgatoel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableDataCovidRSgatoelMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableDataCovidRSgatoel);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(umur, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                                    .addComponent(nomor_telpon)))
                            .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void tableDataCovidRSgatoelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataCovidRSgatoelMouseClicked
        // TODO add your handling code here:
        int baris = tableDataCovidRSgatoel.rowAtPoint(evt.getPoint());
        String IdPasien = tableDataCovidRSgatoel.getValueAt(baris,1).toString();
        id_pasien.setText(IdPasien);
        
        String NamaPasien = tableDataCovidRSgatoel.getValueAt(baris,2).toString();
        nama_pasien.setText(NamaPasien);
        
        String Alamat = tableDataCovidRSgatoel.getValueAt(baris,3).toString();
        alamat.setText(Alamat);
        
        String Umur = tableDataCovidRSgatoel.getValueAt(baris,4).toString();
        umur.setText(Umur);
        
        String KodePos = tableDataCovidRSgatoel.getValueAt(baris,5).toString();
        kode_pos.setText(KodePos);
        
        String NomorTelpon = tableDataCovidRSgatoel.getValueAt(baris,6).toString();
        nomor_telpon.setText(NomorTelpon);   
    }//GEN-LAST:event_tableDataCovidRSgatoelMouseClicked

    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        // TODO add your handling code here:
        try{
            String sql = "INSERT INTO rsgatoel VALUES ('"+id_pasien.getText()+"','"+nama_pasien.getText()+"','"+alamat.getText()+"','"+umur.getText()+"','"+kode_pos.getText()+"','"+nomor_telpon.getText()+"')";
            java.sql.Connection conn =  (Connection)config.configDB();
    ...
    private void editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "UPDATE rsgatoel SET id_pasien='"+id_pasien.getText()+"',nama_pasien='"+nama_pasien.getText()+"',alamat='"+alamat.getText()+"',umur='"+umur.getText()+"',kode_pos='"+kode_pos.getText()+"',nomor_telpon='"+nomor_telpon.getText()+"' WHERE id_pasien = '"+id_pasien.getText()+"'";
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    private void hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusActionPerformed
        // TODO add your handling code here:
        try {
            String sql = "DELETE FROM rsgatoel WHERE id_pasien='" + id_pasien.getText() + "'";
            java.sql.Connection conn = (Connection)config.configDB();
            java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
            pstm.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RSgatoel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tableDataCovidRSgatoel;
